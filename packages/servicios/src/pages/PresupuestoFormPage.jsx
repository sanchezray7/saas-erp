...
export function PresupuestoFormPage() {
  ...
  const [form, setForm] = useState({ contacto: '', direccion: '', fecha_emision: new Date().toISOString().split('T')[0], fecha_validez: '', notas: '' })
    ...
    <div className="card">
      ...
      <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
          <FormField label="Cliente / Contacto" value={form.contacto} onChange={(e) => setForm({ ...form, contacto: e.target.value })} required />
