...
import { $ as $$Hero, a as $$Features, b as $$Testimonios, c as $$Pricing, d as $$PricingTable, e as $$FaqSection, f as $$ContactForm } from '../chunks/ContactForm_BCP5Z0vc.mjs';
export { renderers } from '../renderers.mjs';

const $$Index = createComponent(($$result, $$props, $$slots) => {
  const locale = "es";
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, {}, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Navbar", $$Navbar, { "locale": locale })} ${renderComponent($$result2, "Hero", $$Hero, { "locale": locale })} ${renderComponent($$result2, "Features", $$Features, { "locale": locale })} ${renderComponent($$result2, "Testimonios", $$Testimonios, { "locale": locale })} ${renderComponent($$result2, "Pricing", $$Pricing, { "locale": locale })} ${renderComponent($$result2, "PricingTable", $$PricingTable, { "locale": locale })} ${renderComponent($$result2, "FaqSection", $$FaqSection, { "locale": locale })} ${renderComponent($$result2, "ContactForm", $$ContactForm, { "locale": locale })} ${renderComponent($$result2, "Footer", $$Footer, { "locale": locale })} ` })}`;
